...
def do_the_job():
    ...
    with open(filename) as ifile:
        for line in ifile:
            ...
            if state == STATE_TEST_ENDED:
                ...
                m = pattern_grambox.findall(line)
                if not m: continue
    ...
    with open('3k_with_grambox_EnEn.txt', 'w') as the_file:
        the_file.write(results_3k)
    with open('6k_with_grambox_EnEn.txt', 'w') as the_file:
        the_file.write(results_6k)
    with open('9k_with_grambox_EnEn.txt', 'w') as the_file:
        the_file.write(results_9k)
    with open('9k_out_with_grambox_EnEn.txt', 'w') as the_file:
